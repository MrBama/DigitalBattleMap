...
namespace DrawingCanvas
{
    public class CustomInkCanvas : InkCanvas
    {
        ...
        public static readonly DependencyProperty ActiveShapeProperty = DependencyProperty.Register(nameof(ActiveShape), typeof(DrawingShape), typeof(CustomInkCanvas), new PropertyMetadata(OnActiveShapeDependencyPropertyChanged));
        public static readonly DependencyProperty ShapeCollectionProperty = DependencyProperty.Register(nameof(ShapeCollection), typeof(DrawingShapeCollection), typeof(CustomInkCanvas), new PropertyMetadata(OnShapesDependencyPropertyChanged));
        ...
        {
            var canvas = (CustomInkCanvas)dependencyObject;
        ...
        private void DrawShape(DrawingShape shape)
        {
            if (shape.Points.Count > 0)
            {
                var inkPointEllipse = CreateStroke(shape);
                Strokes.Add(inkPointEllipse);
                _strokes[shape] = inkPointEllipse;
            }
        }
